...
$('.navbar-toggler').on('click dblclick', function () {
  if ($('.navbar-toggler span').hasClass('icon-menu')) {
    $('.navbar-toggler span').removeClass('icon-menu').addClass('icon-cancel');
  } else {
    $('.navbar-toggler span').removeClass('icon-cancel').addClass('icon-menu');
  }
});
